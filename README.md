...
use the input to upload as a file,
the modules should give you a page with either hit or miss.

If the results are a hit, it will give you with a link to the node.
